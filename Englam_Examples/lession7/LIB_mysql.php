...
define("MYSQL_PASSWORD", "12345678");         // Define your MySQL password
define("DATABASE", "php_scraping");               // Define your default database
...
function insert($database, $table, $data_array)
	...
	#mysqli_select_db ($database, $mysql_connect);
    ...
    #$result = mysqli_query($sql, $mysql_connect);
